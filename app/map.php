                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        for(var i in parseJSON){
                            $("#appendAreasSideNav").append('<div class="col s6"><input class="imgArea" type="image" src="' + parseJSON[i].img + '" style="width: 100%; height: 5%;" lat="40.642742948915' + parseJSON[i].id + '" long="-8.7449920082118' + parseJSON[i].id + '"/><b id="nomeArea" class="truncate" style="color: #757575; font-size: 11px;">' + parseJSON[i].name + '</b><div class="progress" style="margin-bottom: -10px; margin-top: -5px;"><div id="img_' + parseJSON[i].id + '" class="determinate" style="width: 100%"></div></div><b id="text_' + parseJSON[i].id + '" style="color: #757575; font-size: 11px;">Livres:</b></div>');
