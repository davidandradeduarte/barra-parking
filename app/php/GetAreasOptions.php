...
<script> 
    ...
    $("#appendAreasModalChips").append('<div id="area<?php echo $area['id']; ?>" class="cardContentAreas"><div id="chipNomeArea" class="chip"><b>Área escolhida: <?php echo $area['nome']; ?></b></div></div>');
