        ...
        <div class="modal-content">
            ...
            <p>
                <div class="card z-depth-0">
                    ...
                    <div id="appendAreasModalChips" class="card-content grey lighten-5 center-align" style="margin-top: -20px;"></div>
                </div>
            </p>
        </div>
        <div id="modalOptions" class="modal-footer" style="margin-top: -25px">
            <a id="modalButton" class="btn blue darken-3 modal-action modal-close">
            ...
            ReloadAreasParkingsFree: function () {
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        for(var i in parse){
                            alteraLugares('img_' + parse[i].id, 100-((parse[i].free_places/parse[i].space)*100) , 'text_' + parse[i].id, parse[i].free_places);
                        }
                    },
                    error: function (response) {
                        Parking.toasts("Erro ao obter pontos de interesse");
...
<?php include 'php/GetAreasOptions.php';?>
</body>
